...
import { BrainstormScene } from "./Scenes/BrainstormScene";
import { TDDScene } from "./Scenes/TDDScene";
...
export const SuperPowers: React.FC<SuperPowersProps> = (props) => {
  const {
    sceneDurations,
    subtitle,
    voiceoverScripts,
  ...
  const SCENES: React.FC<SuperPowersProps>[] = [
    HookScene,
    ProblemScene,
    PipelineScene,
    BrainstormScene,
