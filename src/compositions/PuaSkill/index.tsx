...
import { LazyPatternsScene } from "./Scenes/LazyPatternsScene";
import { ThreeRulesScene } from "./Scenes/ThreeRulesScene";
...
export const PuaSkill: React.FC<PuaSkillProps> = (props) => {
  const {
    sceneDurations,
    subtitle,
    voiceoverScripts,
  ...
  const SCENES: React.FC<PuaSkillProps>[] = [
    HookScene,
    LazyPatternsScene,
    ThreeRulesScene,
    PressureScene,
